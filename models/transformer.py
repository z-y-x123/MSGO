"""
Author: Zheng Ma
Date: 2022-02-19 15:14:32
LastEditTime: 2022-02-25 15:35:01
LastEditors: Zheng Ma
Description: 
FilePath: /smiles_generate/models/transformer.py
...
class EncoderDecoder(nn.Module):
    ...
    def forward(self, src, tgt, formula, mol_mass, src_mask, tgt_mask):
        """Take in and process masked src and target sequences."""
        return self.decode(self.encode(src, src_mask), src_mask,
                            tgt, tgt_mask, formula, mol_mass)
    
    def encode(self, src, src_mask):

        return self.encoder(self.src_embed(src), src_mask)
    
    def decode(self, memory, src_mask, tgt, tgt_mask, formula, mol_mass):
        
        return self.decoder(self.tgt_embed(tgt, formula, mol_mass), memory, src_mask, tgt_mask)
...
class DecodeEmbedding(nn.Module):
    def __init__(self, d_model, token_size, formula_size, mol_mass_size, dropout):
